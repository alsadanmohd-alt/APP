...
export type Booking={id:string;item_id:string;renter_id:string;owner_id:string;status:'pending'|'accepted'|'rejected'|'cancelled'|'completed';created_at:string};
...
export const categories=['الكل','تصوير','رحلات','أدوات ومعدات','رياضة','منزل','إلكترونيات','تجهيز الحفلات','أدوات مطبخ'];
