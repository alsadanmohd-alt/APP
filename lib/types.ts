...
export type Booking={id:string;item_id:string;renter_id:string;owner_id:string;status:'active'|'completed';created_at:string};
...
export const statuses={active:'قيد التواصل',completed:'مكتمل'};
